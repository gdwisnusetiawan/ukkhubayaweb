...
@section('breadcumb')
  ...
  <li class="breadcrumb-item"><a href="{{ route('managements.index') }}">Panitia</a></li>
...
<div class="row">
  <div class="col-md-8">
    <div class="card">
      ...
      <div class="card-body">
      	<form action="{{ route('management.member.update', [$management, $member]) }}" method="post" class="form-horizontal" id="form-edit">
	        	@csrf
	        	@method('put')

	        	<input type="hidden" name="management_id" value="{{ $management->id }}">
	        	<div class="form-group row">
	            <label for="period_id" class="col-sm-2 col-form-label">Kegiatan</label>
	            <div class="col-sm-10">
	          ...
	          <div class="form-group row">
	            ...
	            <div class="col-sm-10">
	              ...
	              <input type="hidden" class="form-control @error('position_id') is-invalid @enderror" name="position_id" value="{{ $management->position->id }}" required autocomplete="event_id" placeholder="Periode">
	              @error('position_id')
	                <span class="invalid-feedback" role="alert">
	                  <strong>{{ $message }}</strong>
	                </span>
