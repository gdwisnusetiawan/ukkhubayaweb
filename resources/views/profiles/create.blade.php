...
<div class="row">
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
      	<form action="{{ route('profiles.store') }}" method="post" class="form-horizontal" id="form-add" enctype="multipart/form-data">
	        	@csrf
	          ...
	          <div class="form-group row">
	            ...
	            <div class="col-sm-10">
	            	...
	            	<img src="" id="logoDisplay" class="img-fluid img-thumbnail mt-3" alt="Logo Profil" style="max-width: auto; height: 240px;">
	            </div>
	          </div>
	          <div class="form-group row">
              ...
              <div class="col-sm-10">
                  ...
                  <input type="text" class="form-control datetimepicker-input @error('established') is-invalid @enderror" data-target="#established" data-toggle="datetimepicker" name="established" autocomplete="off" value="{{ old('established') }}">
	          ...
	          <div class="form-group row">
	            ...
	            <div class="col-sm-10">
	              <textarea class="textarea form-control @error('vision') is-invalid @enderror" name="vision" autocomplete="vision"
                          style="font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('vision') }}</textarea>
	              @error('vision')
	                <span class="invalid-feedback" role="alert">
	                  <strong>{{ $message }}</strong>
	                </span>
