  ...
  <div class="col-md-3">
    ...
    <div class="card">
      <div class="card-header">
        <a href="{{ url()->current() == url()->previous() ? route('committees.index') : url()->previous() }}"><i class="fas fa-chevron-left"></i> Kembali</a>
      </div>
      ...
      <div class="card-body">
        <div class="tab-content">
          ...
          <div class="tab-pane" id="member">
            ...
            <a href="{{ route('committee.member.create', $committee) }}" class="btn btn-primary float-right"><i class="fas fa-plus"></i><span class="button-text"> Tambah</span></a>
